...
public class Guides {
    ...
    static {
        ...
        registerGuide(PropertySpecificGuesserGuide.class,
                ...
                ChestBlock.class,
                SnowBlock.class, SeaPickleBlock.class, LeverBlock.class, EndPortalFrameBlock.class,
        ...
        registerGuide(BlockReplacementGuide.class, SnowBlock.class, SeaPickleBlock.class,
                SlabBlock.class);
    ...
    public Guide[] getInteractionGuides(SchematicBlockState state) {
        ...
        return applicableGuides.toArray(new Guide[0]);
    }
}
